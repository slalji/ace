...
<![endif]-->
		...
		<script type="text/javascript">
				...
				var myTable =
					$('#dynamic-table').DataTable( {
						...
						ajax: {
							...
							type: 'GET',
							dataType: 'json',
							data: {groupid: '', phone: '', ref: '', startDate: '', endDate: ''}
						},
						"columns": [
							{ "data": "id" },
							{ "data": "fulltimestamp" },
				...
				//$("div.toolbar").html('<div id="min-date" class="pull-left" style="border-radus:5px ;background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 30%"> <i class="glyphicon glyphicon-calendar fa f-calendar"></i>&nbsp;<span></span> <b class="caret"></b></div>');
			...
			*/
// Extend dataTables search dateRange search
